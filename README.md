...
Step 2, generating property files for grid generation, executes the file "gridGenerator.py". The parameters include user-defined global and local grid refinement. For further information about the m-AIA grid generator, see:
