...
Step 2, generating property files for grid generation, is demonstrated for two use cases: m-AIA and OpenFOAM. The property files are generated by executing the file "gridGenerator.py". The parameters include user-defined global and local grid refinement. For further information about the m-AIA grid generator, see:
